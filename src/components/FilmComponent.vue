<template>
  <div
  class="overflow-hidden rounded-xl relative
  hover:scale-110 transform duration-200">
    ...
    alt="poster"
    />
    <h3 class="text-white text-2xl mb-5 truncate">
      {{ film.nameRu }}
    </h3>
    <p class="text-white text-sm font-light mb-2"
    >Жанры:
    {{ genreList() }}
  </p>
    <p class="text-white text-sm font-light mb-2">
    ...
    <div
      ...
      justify-center w-16 h-16 cursor-pointer"
